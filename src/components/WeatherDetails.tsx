        ...
        <>
            <div className='weather-details'>
                ...
                <div className='historical-weather-details'>
                    <span className='weather-details-text'>H:{historicalWeather?.data[0].max_temp}&deg;</span>
                    <span className='weather-details-text'>L: {historicalWeather?.data[0].min_temp}&deg;</span>
                </div>

                <div className='location'>
                    <div className='weather-details-text'>{location?.city_name}, {location.country_code}</div>
